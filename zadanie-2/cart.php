                ...
                <div class="col-12 text-center">
                    <div class="page-header-content">
                        <div class="page-header-content-inner">
                            <h1 style="font-size: 50px;">Корзина</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="cart-calculate-area mt-sm-40 mt-md-60">
                            ...
                            <div class="cart-cal-table table-responsive">
                                <table class="table table-borderless">
                                    ...
                                    <tr class="cart-sub-total">
                                        <th>Оплата осуществляется <br> на месте оформления</th>
                                    </tr>
                            ...
                            <div class="proceed-checkout-btn">
                                <a onclick="saveOrder(<?php echo $idUser  ?>)" class="btn btn-brand d-block">Оформить заявку</a>
                            </div>
                        </div>
                    </div>
                </div>
