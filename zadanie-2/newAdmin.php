			...
			<div class="fixed">
				<div class="menu_select">
					...
					<form class="searh" onsubmit="return false;">
						<input class="searh_input" type="text" id="input_text" placeholder="Введите Название техники">
			...
			<form action="addProduct.php" enctype="multipart/form-data" method="post" style="padding: 50px; background-color:#f0ecec" class="subscription relative">
				<div style="display: flex;align-items: center;flex-direction: column">
					...
					<div>
						...
						<textarea style="resize: vertical" rows="5" cols="40" name="category" type="text" placeholder="введите Категорию" style="width:300px"></textarea>
					</div>
					<div>
						<span>
							<h4>Цена</h4>
					...
					<div>
						...
						<input name="exp" type="number" placeholder="введите срок гарантии" style="width:300px">
					</div>
					<div>
						<span>
							<h4>Фото 200*200</h4>
						</span>
						<input name="pic200" type="file" placeholder="введите срок гарантии" style="width:300px">
					</div>
					<div>
						<span>
							<h4>Фото 600*600</h4>
						</span>
						<input name="pic600" type="file" placeholder="введите срок гарантии" style="width:300px">
					</div>
					<div class="div_but">
					<button class="primary_btn butt" preventDefault type="submit" style="margin-top:20px ;">Добавить</button>
					<input class="primary_btn butt" type="button" onclick="add_block_hiden(11)" value="Отмена" style="margin-top:20px ;">
					</div>
				</div>
			</form>
		</div>
			...
			<form action="updateProduct.php" enctype="multipart/form-data" method="post" style="padding: 50px; background-color:#f0ecec" class="subscription relative">
				<div style="display: flex;align-items: center;flex-direction: column">
					...
					<div>
						...
						<input name="exp" type="number" placeholder="введите Срок эксплуатации" style="width:300px">
					</div>
					<div>
						<span>
							<h4>Фото 200*200</h4>
						</span>
						<input name="pic200" type="file" placeholder="введите Срок эксплуатации" style="width:300px">
					</div>
					<div>
						<span>
							<h4>Фото 600*600</h4>
						</span>
						<input name="pic600" type="file" placeholder="введите Срок эксплуатации" style="width:300px">
					</div>
					<div class="div_but">
